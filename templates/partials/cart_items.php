<div class="prodigy-cart-dropdown__body cart-dropdown-widget-item-list-js">
	...
	<?php foreach ( $cart_products as $remote_product_id => $product ) : ?>
		...
		$image_src = ! empty( $image ) ? '<img loading="lazy" alt="' . esc_html( 'Product', 'prodigy' ) . '" width="150" src="' . $image['thumbnails'] . '" srcset="' . $image['thumbnails'] . ' 1x, ' . $image['thumbnails_retina'] . ' 2x" />' : '';
		?>
		<div class="prodigy-cart-item prodigy-cart-item__widget-item widget-cart-item-js">
			<div class="d-flex flex-column prodigy-cart__placeholder-wrap">
                <div class="prodigy-cart__placeholder">
                    <a class="prodigy-cart-item__link" href="<?php echo esc_url( get_permalink( $product['local_parent_product_id'] ) ); ?>">
			...
			<div class="prodigy-cart-item__info">
				<a class="prodigy-cart-item__info-title" href="<?php echo esc_url( get_permalink( $product['local_parent_product_id'] ) ); ?>"><?php echo esc_attr( $product['name'] ); ?></a>
				<div class="prodigy-cart-item__info-price widget-cart-product-price-js">
					...
					<div class="prodigy-cart-item__info-price-prc">
						...
						<span class="prodigy-cart-item__info-price__value widget-total-price-js">
							$<?php echo esc_attr( \Prodigy\Includes\Helpers\Prodigy_Formatting::prodigy_price_format( $product['actual_price'] ) ); ?>
						</span>
					</div>
				</div>
						...
						<div>
							<div class="prodigy-cart-item-subscr__item">
								...
								<?php if ( $product['subscriptions']['attributes']['interval'] > 1 ) : ?>
									<span class="prodigy-cart-item-subscr__value"><?php echo esc_html_e( 'Every', 'prodigy' ) . ' '; esc_attr( $product['subscriptions']['attributes']['interval'] ); ?> <?php echo esc_attr( $product['subscriptions']['attributes']['period'] ); ?>s</span>
								<?php else : ?>
									<span class="prodigy-cart-item-subscr__value"><?php echo esc_html_e( 'Every', 'prodigy' ) . ' '; esc_attr( $product['subscriptions']['attributes']['period'] ); ?></span>
								<?php endif; ?>
							</div>
                ...
                <ul class="prodigy-cart-item__info-variants prodigy-cart-item__info-logo-variants">
					<?php if ( ! empty( $product['logo_options'] ) ) : ?>
						...
						<?php foreach ( $product['logo_options'] as $key => $item ) : ?>
							...
							<?php $logo_name = empty( $logo_charge_amount ) ? $item['logo']['name'] : $item['logo']['name'] . ' (+$' . $logo_charge_amount . ')'; ?>
                            <li>
                                <?php $logo_title = empty( $i ) ? 'Logo:' : esc_html( sprintf( __( 'Logo %d', 'prodigy' ), $i ) ) . ':';  ?>
                                <span class="prodigy-cart-item__info-variants__name prodigy-cart-item__info-logo__name . <?php echo esc_attr( $key ); ?>"><?php echo $logo_title; ?></span>
                            ...
                            <li>
                                ...
                                <span class="prodigy-cart-item__info-variants__name prodigy-cart-item__info-location__name . <?php echo esc_attr( $key ); ?>"><?php echo $location_title; ?></span>
