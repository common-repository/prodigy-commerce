...
class Prodigy_Api_Client {
	 ...
	 * @return array
	 */
	public function get_list_errors( $response_remote ) {
		$message_error = json_decode( wp_remote_retrieve_body( $response_remote ) );
	 ...
	 * @return array
	 */
	public function response_error( WP_Error $response ) {
	 ...
	 */
	public function post_remote_content( string $api_url, array $params = array(), $headers = '' ) {
	 ...
	 * @return array|WP_Error
	 */
	public function patch_remote_content( string $api_url, array $params = array(), $headers = '' ) {
	 ...
	 * @return array|WP_Error
	 */
	public function put_remote_content( string $api_url, $params = array(), $headers = '' ) {
	 ...
	 * @return array|WP_Error
	 */
	public function get_remote_content( string $api_url, $headers = '' ) {
		if ( PRODIGY_DEBUG_MODE ) {
			do_action( 'logger', __LINE__ . __METHOD__ . __CLASS__ . ' ' . $api_url, 'info' );
		}
		$request  = ! empty( $headers ) ? $headers : $this->request;
