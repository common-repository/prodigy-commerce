...
namespace Prodigy\Includes\Synchronization;
...
class Prodigy_Synchronization {
	...
	const PRODIGY_PROCESS_TYPE_AUTO_SYNC = 'prodigy_process_type_auto_sync';
	 ...
	 * @param string $type_process
	 *
	 * @return bool
	 * @throws Prodigy_Demo_Content_Exception
	 */
	public function run_sync_process( string $process_url, string $type_process ): bool {
		...
		$result   = false;
		update_option( self::PRODIGY_SYNCHRONIZATION_TYPE, $type_process );
